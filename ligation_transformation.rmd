...
3.  Add 100 ml of 1x TAE (Tris base, acetic acid, EDTA) running buffer.
4.  Add 10 µl of SybrGreen™ dye (10,000x stock solution).
...
2. Transfer 20 μl of each PCR reaction into the labeled microcentrifuge tube. Add 4 μl of loading dye and stain into the tube. Pipette up and down to mix.
...
4. Check if the agarose gel has solidified. If so, proceed to the next step or wait until the gel is ready.
4. Pour electrophoresis running buffer into the chamber until it just covers the gel by 1–2 mm.
5. Load 10 μl of the 500 bp molecular weight ruler into the first well. 
6. Load 20 μl from each microcentrifuge tube containing an initial PCR with added loading dye. Load 5 μl from each tube containing a nested PCR with added loading dye into the wells of the gel according to your plan.
...
## Experimental Procedureqs 

1. Label a PCR Kleen spin column and a capless collection tube with your initials.
...
5. Place the spin column, still in the capless collection tube, into the microcentrifuge. Make sure that your tube is placed in the rotor with another group’s or with a balance tube so that the microcentrifuge is balanced.
...
7. Pipet 30 μl of the nested PCR product onto the top of the column bed in the spin column, without disturbing the resin (or column bed).
Save 5 μl of this original (unpurified) yellow PCR sample and mix it with 1 μl of 6x loading dye and stain for gel electrophoresis.
...
10. Add 1 μl of 6x loading dye and stain into 5 μl of the purified sample. 
11. Electrophorese 5 μl of this mix next to 5 μl of the unpurified sample on a 1% agarose gel to visualize differences between the original and the purified sample.
...
4. Add 5.0 μl 2x ligation reaction buffer to the labeled microcentrifuge tube.
5. Add 1.0 μl purified PCR product
6. Add 2.5 μl sterile water
7. Add 0.5 μl proofreading polymerase
...
6. Cool the tube on ice for 2 min. This recondenses water vapor to maintain the reaction volume.
Centrifuge the tube briefly to collect the contents at the bottom of the tube. Maintain the tube at room temperature.
7. Add 0.5 μl T4 DNA ligase
8. Add 0.5 μl pJet1.2 blunted vector        
...
12. Pipet 5 μl of the ligation reaction into a fresh microcentrifuge tube labeled with your initials and “t" for "transformation” and store it on ice until needed for the transformation.
...
2. Label 2 LB amp IPTG agar plates with your initials (on the bottom of the plate, not the lid). Also label one of the plates “pGAP” for the control plasmid and the other for your ligation (pJET + your plant name).
   3. Pipet 150 μl of fresh E. coli starter culture (inoculated one day prior) into the prewarmed C-growth medium and place in a 37°C incubator or water bath for 20–40 min shaking at 275 rpm.
4. Label a 1.5 microcentrifuge tube with your initials and “competent cells.”
5. Prepare transformation buffer by combining 250 μl of transformation reagent A and
250 μl of transformation reagent B into a tube labeled “TF buffer” and mix thoroughly with a vortex mixer. Keep on ice until use. 
...
8. Locate the pellet of bacteria at the bottom of the tube. Remove the culture supernatant, avoiding the pellet, using a 1,000 μl pipet. Keep the cells on ice.
9. Pipet 300 μl of ice-cold transformation buffer into the microcentrifuge tube containing the bacterial pellet. Resuspend the pellet by gently pipetting up and down in the solution above the pellet with a 1,000 μl pipet, and gradually wear away the pellet from the bottom of the tube. Make sure that the bacteria are fully resuspended, with no clumps. Avoid removing the cells from the ice bucket for more than a few seconds.
