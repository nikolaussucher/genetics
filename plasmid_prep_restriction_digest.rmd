...
1. Label one capless collection tube, one plasmid mini column, and two microcentrifuge tubes for each miniprep culture with your initial and "M" for “miniprep”.
...
transferring any precipitate. If necessary, recentrifuge the microcentrifuge tubes. Discard the empty microcentrifuge tubes.
12. Centrifuge the columns in the capless collection tubes for 1 min at top speed.
...
2. Incubate reactions at 37°C for 1 hr. If the reactions will not be analyzed by agarose gel electrophoresis immediately, store them at –20°C until analysis.
3. While the restriction digest is incubating, prepare an agarose gel.
3. Combine 5 µl of miniprep DNA with 15 µl of sterile water.
...
|Reagent                   |Volume|
|:-------------------------|:-----|
|10x BgI II reaction buffer|2 µl
|Sterile water             |7 µl
|BgI II enzyme             |1 µl
|Total                     |10 µl
