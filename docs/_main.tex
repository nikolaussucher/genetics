...
\item
  ...
  tube. Add 4 μl of loading dye and stain into the tube. Pipette up and
  down to mix.
\item
  To assess the success of the nested PCR round, pipet 5 μl of each
...
\item
  Load 10 μl of the 500 bp molecular weight ruler into the first well.
\item
  Load 20 μl from each microcentrifuge tube containing an initial PCR
  with added loading dye. Load 5 μl from each tube containing a nested
