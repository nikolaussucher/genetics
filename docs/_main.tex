...
\begin{center}\includegraphics[width=0.7\linewidth]{mendel_files/figure-latex/chi-squared_dist-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{mendel_files/figure-latex/chi-squared-1} \end{center}
