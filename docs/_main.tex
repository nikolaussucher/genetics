...
\tightlist
\item
  Label a microcentrifuge tube for each of the two exonuclease-treated
  first-round PCR tubes.
\item
...
\item
  Label 4 fresh PCR tubes with numbers 1 to 4 and your initials.
\item
  Place them in PCR tube adaptors on ice.
\item
  Pipet 20 µl of 2× MMNP into each of the three PCR tubes.
\item
  Using a fresh tip, pipet 20 µl of the each diluted first-round PCR
  into tube \#1 and \#2, respectively. Close the cap.
\item
  Use a fresh pipet tip to add 20 µl of plasmid DNA (positive control)
  to tube \#3. Gently pipet up and down to mix the reagents. Recap the
  tubes.
\item
  Use a fresh pipet tip to add 20 µl of plasmid DNA (positive control)
  to tube \#3.
