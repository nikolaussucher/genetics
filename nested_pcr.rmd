...
1. Label a microcentrifuge tube for each exonuclease-treated initial PCR tube.
5. To dilute each initial PCR sample 20× (to 1/50 the original concentration), add 98 µl of sterile water into each of the labeled microcentrifuge tubes.
6. Using a fresh tip each time, pipet 2 µl of the initial PCR into the corresponding  microcentrifuge tube. Close the cap.
...
8. Label 3 fresh PCR tubes #1-3 and your initials. 
9. Place them in PCR tube adaptors on ice. 
9. Pipet 20 µl of 2× MMNP into each of the three PCR tubes.
6. Using a fresh tip, pipet 20 µl of the initial PCR into tube #1. Close the cap.
7. Use a fresh pipet tip to add 20 µl of plasmid DNA (positive control) to tube #2. Gently pipet up and down to mix the reagents. Recap the tubes.
10. Use a fresh pipet tip to add 20 µl of plasmid DNA (positive control) to tube #2.
11. Use a fresh pipet tip to add 20 µl of sterile water (negative control) to PCR tube #3. 
